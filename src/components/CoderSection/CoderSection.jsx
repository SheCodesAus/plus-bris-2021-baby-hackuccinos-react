  ...
  return (
    <div class="coder-section-main-div">
      ...
      <div class="coder-section-h3">
        <h3>
          These incredible coders have achieved so much, whether that be simply
          new skills or a brand new career in tech! Check out the badges to
          discover their incredible feats!
        </h3>
      </div>
      <div class="legend">
        <img
